...
const FAQs = () => {
  return (
    <div className="bg-gradient-to-br from-blue-100 to-purple-200 min-h-screen flex flex-col items-center py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800">FAQs</h1>
        <p className="text-lg text-gray-600 mt-2">Find Your Answers Here</p>
      </div>
